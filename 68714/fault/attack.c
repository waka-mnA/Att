...
gmp_printf("4 S1: %ZX\n", c);
  ...
  for (int i = 0;i<sizeof(a)/sizeof(a[0]);i++) printf("a1 %d ", a[i]);
  printf("\n");
  a = reduceKeySpace(k8);
  for (int i = 0;i<sizeof(a)/sizeof(a[0]);i++) printf("a2 %d ", a[i]);
  printf("\n");
  a = reduceKeySpace(k11);
  for (int i = 0;i<sizeof(a)/sizeof(a[0]);i++) printf("a3 %d ", a[i]);
  printf("\n");
  a = reduceKeySpace(k14);
  for (int i = 0;i<sizeof(a)/sizeof(a[0]);i++) printf("a4 %d ", a[i]);
  printf("\n");
  a = reduceKeySpace(k1_2);
  for (int i = 0;i<sizeof(a)/sizeof(a[0]);i++) printf("a5 %d ", a[i]);
  printf("\n");
  a = reduceKeySpace(k8_2);
  for (int i = 0;i<sizeof(a)/sizeof(a[0]);i++) printf("a6 %d ", a[i]);
  printf("\n");
  a = reduceKeySpace(k11_2);
  for (int i = 0;i<sizeof(a)/sizeof(a[0]);i++) printf("a7 %d ", a[i]);
  printf("\n");
  a = reduceKeySpace(k14_2);
  for (int i = 0;i<sizeof(a)/sizeof(a[0]);i++) printf("a8 %d ", a[i]);
  printf("\n");
